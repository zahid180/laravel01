			...
			<div class="filter-price">
				<h3>Filter By Price</h3>
					<ul class="dropdown-menu6">
						...
						<script type="text/javascript" src="{{asset('fontEndjs/jquery-ui.js')}}"></script>
					 <!---->
			</div>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="{{asset('fontEnd/images/men1.jpg')}}" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('fontEnd/images/men2.jpg')}}" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('fontEnd/images/men1.jpg')}}" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="{{asset('fontEnd/images/men3.jpg')}}" alt=" " />
				</div>
		...
		<div class="single-pro">
			...
			<div class="col-md-3 product-men yes-marg">
						...
						<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('fontEnd/images/ep4.png')}}" alt="" class="pro-image-front">
									<img src="{{asset('fontEnd/images/ep4.png')}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
